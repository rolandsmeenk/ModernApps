...
function initializeLiquidParticles(id, x, y, w, h)
{

    var tCanvas = document.getElementById(id + "_mc");
    if (tCanvas != null || tCanvas != undefined)
    {
        var tCanvasContext = tCanvas.getContext("2d");

        tCanvasContext.save();
        tCanvasContext.font = "normal 16px Segoe UI";
        tCanvasContext.fillStyle = "black";
        tCanvasContext.fillText("canvas", 20, 20);
        tCanvasContext.restore();
    }
}



//This is what you need in HTML for this script to work
//<div id="outer">
