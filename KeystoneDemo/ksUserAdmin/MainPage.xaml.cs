...
namespace ksUserAdmin
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var userList = await ksWebServices.CallServices.GetUserList(loggedIn.Item1.MemberId, loggedIn.Item3.RequestDTO.EntityTypeId, loggedIn.Item2.Id);
            ...
            //var jsonSerialized = JsonConvert.SerializeObject(userList.Item1.Results.Take(3000));
