...
class ReaderComposeMail01 extends Layout003 {
        ...
        super.Show(
           ...
           ],
           {
               ...
               "items": [
                            ...
                            { "id": "tb10", "text": "Close", "data": "action|execute parent|close rss", "style": 'background-image:url("/Content/icons/dark/close.png");background-position:0px 0px;background-size:50px; background-repeat:no-repeat;padding-left:35px; float:right; margin-right:180px;' },
               ],
               "title": "MAIL",
               "titleLength": 170,
