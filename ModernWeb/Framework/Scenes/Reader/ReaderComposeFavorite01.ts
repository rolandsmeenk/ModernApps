    ...
    public Show() {
        ...
        super.Show(
           ...
           ],
           {
               ...
               "items": [
                            { "id": "tb1", "text": "Save", "data": "action|execute parent|close favorite", "style": 'background-image:url("/Content/icons/dark/save.png");background-position:0px 0px;background-size:50px; background-repeat:no-repeat;padding-left:35px;' },
                            { "id": "tb10", "text": "Close", "data": "action|execute parent|close favorite", "style": 'background-image:url("/Content/icons/dark/close.png");background-position:0px 0px;background-size:50px; background-repeat:no-repeat;padding-left:35px; float:right; margin-right:270px;' },
               ],
               "title": "FAVOURITE",
               "titleLength": 260,
