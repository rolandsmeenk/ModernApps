...
var ReaderComposeRss01 = (function (_super) {
    __extends(ReaderComposeRss01, _super);
    function ReaderComposeRss01(UIRenderer, Debugger) {
        var _this = this;
    ...
    ReaderComposeRss01.prototype.ExecuteAction = function (data) {
        this.Debugger.Log("ReaderComposeRss01.ExecuteAction params = " + data);
        if(data != null) {
            var parts = data.split("|");
            this.Debugger.Log("url : " + parts[2]);
        }
    };
    ReaderComposeRss01.prototype.Show = function () {
        ...
        this.Debugger.Log("ReaderComposeRss01.Show");
    ...
    ReaderComposeRss01.prototype.Unload = function () {
    ...
    ReaderComposeRss01.prototype._Init = function (startHeight) {
