    ...
    public Show() {
        ...
        super.Show(
           ...
           ],
           {
               ...
               "items": [
                   { "id": "tb10", "text": "Edit", "data": "scene|ReaderComposeMessage01", "style": 'color:white; background-image:url("/Content/icons/dark/edit.png");background-position:0px 0px;background-size:50px; background-repeat:no-repeat;padding-left:35px; float:right; margin-right:220px;' },
                   { "id": "tb11", "text": "", "data": "act|ReaderHelpMessage01", "style": 'color:white; background-image:url("/Content/icons/dark/questionmark.png");background-position:0px 0px;background-size:50px; background-repeat:no-repeat;padding-left:35px;float:right;' },
               ],
               "title": "READER",
               "titleLength": 190,
