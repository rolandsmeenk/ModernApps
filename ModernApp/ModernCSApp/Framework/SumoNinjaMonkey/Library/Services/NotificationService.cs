...
namespace SumoNinjaMonkey.Framework.Services
{
    public class NotificationService
    {
        ...
        {
            Show(message, title, new SolidColorBrush(Colors.Transparent), new SolidColorBrush(Colors.White), new SolidColorBrush(Colors.Yellow), timeToLive, autoHide, width, height);
        }
