...
{
    public sealed partial class MsgBoxView : UserControl
    {
        ...
        public static readonly DependencyProperty BackgroundFillProperty =
            DependencyProperty.Register("BackgroundFill", typeof(Brush), typeof(MsgBoxView), new PropertyMetadata(0, BackgroundFillPropertyChanged));

        private static void BackgroundFillPropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            MsgBoxView ctl = (MsgBoxView)obj;
        ...
        public static readonly DependencyProperty MessageTextForegroundColorProperty =
            DependencyProperty.Register("MessageTextForegroundColor", typeof(Brush), typeof(MsgBoxView), new PropertyMetadata(0, MessageTextForegroundColorPropertyChanged));
        ...
        public static readonly DependencyProperty CountdownBackgroundColorProperty =
            DependencyProperty.Register("CountdownBackgroundColor", typeof(Brush), typeof(MsgBoxView), new PropertyMetadata(0, CountdownBackgroundColorPropertyChanged));
        ...
        private void butYes_Click(object sender, RoutedEventArgs e)
        {
            ...
            else msgToSend = new GeneralSystemWideMessage(YesMessengerContent) { Identifier = YesMessengerIdentifier, Action = YesMessengerContent };
