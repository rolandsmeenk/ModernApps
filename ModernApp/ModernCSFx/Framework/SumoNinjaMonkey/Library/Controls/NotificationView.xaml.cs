...
namespace SumoNinjaMonkey.Framework.Controls
{
    public sealed partial class NotificationView : UserControl
    {
        ...
        public static readonly DependencyProperty BackgroundFillProperty =
            DependencyProperty.Register("BackgroundFill", typeof(Brush), typeof(NotificationView), new PropertyMetadata(0, BackgroundFillPropertyChanged));
        ...
        public NotificationView(string msg, string title, bool autoHide, double timeToLive, string metroIcon = "", Brush iconColor = null, string imageIcon = "", double scaleIcon = 1.0)
        {
        ...
        private void LoadMetroIcon(string key, Brush iconColor = null, double rotation = 0, double scaleIcon = 1)
        {
            ...
            if (iconColor == null) iconColor = new SolidColorBrush(Windows.UI.Colors.Purple);
